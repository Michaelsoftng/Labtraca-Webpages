...
const desktopFaqs = [
  {
    ...
    answer:
      "You can track your order in real-time through the 'Orders' tab. Each order provides live GPS tracking and estimated arrival times.",
  },
  {
    question: "What are your support hours?",
    answer:
      "Our clinical logistics support team is available 24/7 to ensure critical medical supplies are delivered without interruption.",
  },
  {
    question: "How to refund a wallet top-up?",
    answer:
      "Wallet refunds can be requested via the Support Form. Please include the transaction ID found in your 'Wallet' history.",
  },
];
...
const mobileFaqs = [
  {
    ...
    answer:
      "Stat specimens can be tracked in real-time via the Orders tab in your Testraca app.",
  },
  {
    question: "What are temperature protocols?",
    answer:
      "All samples are transported in temperature-controlled containers to maintain clinical integrity throughout the delivery chain.",
  },
  {
    question: "New provider onboarding?",
    answer:
      "New healthcare providers can onboard by visiting the Partner With Us page and completing the registration form.",
  },
];
      ...
      <>
        ...
        <div>
          ...
          <textarea
            ...
            rows={4}
            className="w-full px-4 py-3 rounded-xl border border-border bg-canvas text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary resize-none"
          />
        </div>
        <button
          type="submit"
          className="w-full bg-primary text-white py-4 rounded-xl font-bold text-base flex items-center justify-center gap-2 active:scale-[0.98] transition-transform shadow-md"
        >
      ...
      <>
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              type="text"
              placeholder="John Doe"
              className="w-full px-4 py-3 rounded-lg border border-border bg-canvas text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary"
            />
          </div>
          <div>
            <label className="text-xs font-semibold text-gray-600 block mb-1.5">
        ...
        <div>
          ...
          <textarea
            ...
            rows={5}
            className="w-full px-4 py-3 rounded-lg border border-border bg-canvas text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary resize-none"
          />
        </div>
        <button
          type="submit"
          className="bg-primary text-white px-8 py-3 rounded-lg font-bold text-sm hover:bg-primary/90 transition-colors shadow-md"
        >
          Submit Request
        </button>
      </>
      ...
      <main className="sm:hidden pt-16 px-4 pb-20">
        ...
        <section className="pt-8 pb-6">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            Our dedicated logistics and medical support team is available 24/7
            to ensure your clinical operations remain seamless.
          </p>
        </section>
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          <a
            href="tel:+2348133896015"
            className="flex flex-col items-center gap-2 p-5 rounded-2xl bg-white border border-border shadow-sm"
          >
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Quick answers for our healthcare partners.
              </p>
            </div>
            <Link
              to="/faq"
              className="text-sm font-semibold text-primary whitespace-nowrap flex items-center gap-1"
            >
              View All <ArrowRight />
            </Link>
          </div>
        ...
        <div className="relative rounded-2xl overflow-hidden h-44 mb-2 bg-[#062020]">
          ...
          <div className="relative z-10 p-6 flex flex-col justify-end h-full">
            ...
            <p className="text-white/70 text-xs mt-1">
              Learn more about our cold-chain integrity protocols.
            </p>
          </div>
        </div>
      </main>
            ...
            <div className="col-span-3 flex flex-col gap-6">
              ...
              <div className="relative rounded-2xl overflow-hidden h-56 bg-[#062020]">
                ...
                <div
                  ...
                  style={{
                    backgroundImage:
                      "radial-gradient(circle, #00b3b3 1px, transparent 1px)",
                    backgroundSize: "28px 28px",
                  }}
                />
                <div className="relative z-10 p-8 flex flex-col justify-end h-full">
                  <p className="text-white/90 text-base font-medium leading-relaxed max-w-md">
                    Our medical logistics team is always monitoring your
                    shipments for clinical precision.
                  </p>
                </div>
              </div>
            </div>
                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-400 mt-0.5">
                        Priority for urgent sample status
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4 items-start">
                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <div>
                      ...
                      <p className="text-foreground font-semibold text-sm">
                        No. 27 Tai Solarin, off 5th Avenue
                      </p>
                      <p className="text-xs text-gray-400 mt-0.5">
