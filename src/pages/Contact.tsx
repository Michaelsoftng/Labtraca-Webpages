    ...
    {mobile ? (
      <>
        <div>
          ...
          <input type="text" placeholder="John Doe" className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-[#F9F9FF] text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary" />
        </div>
        <div>
          <label className="text-xs font-semibold text-gray-600 block mb-1.5">Email Address</label>
          <input type="email" placeholder="john@clinic.com" className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-[#F9F9FF] text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary" />
        </div>
        <div>
          <label className="text-xs font-semibold text-gray-600 block mb-1.5">Issue Type</label>
          <div className="relative">
            <select className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-[#F9F9FF] text-sm text-gray-700 appearance-none focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary">
        ...
        <div>
          ...
          <textarea placeholder="How can our clinical team assist you?" rows={4} className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-[#F9F9FF] text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary resize-none" />
        </div>
      ...
      <>
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="text-xs font-semibold text-gray-600 block mb-1.5">Full Name</label>
            <input type="text" placeholder="John Doe" className="w-full px-4 py-3 rounded-lg border border-gray-200 bg-[#F9F9FF] text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary" />
          </div>
          <div>
            <label className="text-xs font-semibold text-gray-600 block mb-1.5">Email Address</label>
            <input type="email" placeholder="john@clinic.com" className="w-full px-4 py-3 rounded-lg border border-gray-200 bg-[#F9F9FF] text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary" />
          </div>
        </div>
        <div>
          <label className="text-xs font-semibold text-gray-600 block mb-1.5">Issue Subject</label>
          <div className="relative">
            <select className="w-full px-4 py-3 rounded-lg border border-gray-200 bg-[#F9F9FF] text-sm text-gray-700 appearance-none focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary">
        ...
        <div>
          ...
          <textarea placeholder="Tell us how we can help..." rows={5} className="w-full px-4 py-3 rounded-lg border border-gray-200 bg-[#F9F9FF] text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary resize-none" />
        </div>
    ...
    <div className="min-h-screen bg-[#F9F9FF]">
      ...
      <main className="sm:hidden pt-16 px-4 pb-20">
        ...
        <section className="pt-8 pb-6">
          ...
          <h1 className="text-[36px] font-bold leading-tight text-gray-900 mt-2 mb-3">
        ...
        <div className="relative mb-5">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 bg-white text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary"
          />
        </div>

        {/* Quick actions */}
        <div className="grid grid-cols-2 gap-3 mb-6">
          <button className="flex flex-col items-center gap-2 p-5 rounded-2xl bg-white border border-gray-200 shadow-sm">
            <div className="w-12 h-12 rounded-full bg-[#d1e7e7] flex items-center justify-center">
        ...
        <section className="mb-6">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-xs text-gray-500">Quick answers for our healthcare partners.</p>
            </div>
          ...
          <Accordion type="single" collapsible className="space-y-2">
            {mobileFaqs.map((faq, i) => (
              <AccordionItem
                key={i}
                value={`m-${i}`}
                className="bg-white border border-gray-200 rounded-xl px-4 data-[state=open]:bg-primary/5"
              >
                <AccordionTrigger className="text-sm font-semibold text-gray-800 hover:text-primary py-4">
                  {faq.question}
                </AccordionTrigger>
                <AccordionContent className="text-xs text-gray-500 pb-3 leading-relaxed">
                  {faq.answer}
                </AccordionContent>
              </AccordionItem>
            ))}
      ...
      <main className="hidden sm:block pt-32 pb-20 px-4 md:px-8 bg-white">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="mb-12">
            <span className="text-xs font-bold text-primary uppercase tracking-widest">Support Center</span>
            <h1 className="text-5xl font-black text-gray-900 mt-2 mb-3 leading-tight">
            ...
            <div className="col-span-2 flex flex-col gap-6">
              <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                ...
                <div className="space-y-6">
                  <div className="flex gap-4 items-start">
                    ...
                    <div>
                      <p className="text-xs text-gray-500 mb-0.5">24/7 Support Line</p>
                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <div>
                      <p className="text-xs text-gray-500 mb-0.5">Global HQ</p>
                      <p className="text-gray-900 font-semibold text-sm">1200 Bio-Innovation Way, Ste 400</p>
              ...
              <div className="relative rounded-2xl overflow-hidden flex-1 min-h-[180px] bg-gray-300">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <button className="bg-white text-gray-900 text-sm font-bold px-5 py-2.5 rounded-full shadow-lg flex items-center gap-2 hover:bg-gray-50 transition-colors">
                    <MapPin className="w-4 h-4 text-primary" />
                    View on Map
                  </button>
                </div>
          ...
          <section>
            <div className="flex items-end justify-between mb-8">
              <div>
                ...
                <p className="text-gray-500 mt-1">Quick answers for our healthcare partners.</p>
              </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              {desktopFaqs.map((faq, i) => (
                <Accordion key={i} type="single" defaultValue="item-0" collapsible>
                  <AccordionItem
                    value="item-0"
                    className="bg-white border border-gray-200 rounded-xl px-5 data-[state=open]:bg-primary/5"
                  >
                    <AccordionTrigger className="text-sm font-bold text-gray-800 hover:text-primary py-4 text-left">
                      {faq.question}
                    </AccordionTrigger>
                    <AccordionContent className="text-xs text-gray-500 pb-4 leading-relaxed">
                      {faq.answer}
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
