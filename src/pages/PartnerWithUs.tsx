...
const partnerTypes = [
  ...
  },
  {
    ...
    desc: "Support the expansion of the Testraca network. Scale healthcare delivery with enterprise-grade solutions.",
    color: "bg-card-surface",
      ...
      <main className="sm:hidden pt-16 pb-20">
        <section className="px-4 pt-8 pb-6">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            Scale your health facility or logistics business with our diagnostic
            network.
          </p>
        </section>
          ...
          {partnerTypes.map((pt) => (
            ...
            >
              <div className="flex gap-4">
                <div
                  className={`w-12 h-12 ${pt.color} rounded-xl flex items-center justify-center shrink-0`}
                >
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto leading-relaxed">
              Scale your health facility or logistics business with our
          ...
          <div className="grid grid-cols-3 gap-6 mb-20">
            {partnerTypes.map((pt) => (
              ...
              >
                <div
                  className={`w-14 h-14 ${pt.color} rounded-2xl flex items-center justify-center mb-6`}
                >
