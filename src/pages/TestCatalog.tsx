    ...
    <div className="min-h-screen bg-canvas">
      ...
      <main className="sm:hidden pt-16 px-4 pb-20">
        <section className="pt-8 pb-4">
          ...
          <p className="text-sm text-muted-foreground">Browse individual tests or curated packages.</p>
        </section>
      ...
      <main className="hidden sm:block pt-32 pb-20 px-4 md:px-8">
        <div className="container mx-auto max-w-6xl">
          <div className="mb-10">
            ...
            <p className="text-muted-foreground">Browse individual tests or curated packages.</p>
          </div>
