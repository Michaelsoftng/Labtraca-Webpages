...
const HospitalDetails = () => {
  ...
  const hospital = (userData as any)?.getUserByIdPublic;
    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <div className="flex flex-col items-center justify-center h-[60vh] gap-4">
          ...
          <Button asChild>
            <Link to="/app/hospitals">Go Back</Link>
          </Button>
        </div>
        <Footer />
      </div>
                ...
                <div className="space-y-2">
                  {hospital.streetAddress && (
                    <div className="flex items-start gap-2">
                      ...
                      <span>
                        {hospital.streetAddress}, {hospital.city},{" "}
                        {hospital.state}
                      </span>
                    </div>
                  )}
                  {hospital.facilityAdmin?.openingHours && (
                    <div className="flex items-center gap-2">
                      <Clock className="w-4 h-4 text-primary shrink-0" />
                      <span>{hospital.facilityAdmin.openingHours}</span>
                    </div>
                  )}
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            <div className="bg-card border rounded-2xl p-6 shadow-sm space-y-4 sticky top-24">
              <h3 className="font-bold text-lg">Contact Hospital</h3>
              <p className="text-sm text-muted-foreground">
                Contact this specific facility for test availability or visit
                details.
              </p>
