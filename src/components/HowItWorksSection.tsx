  ...
  return (
    <section className="py-16 md:py-24 px-4 md:px-8 bg-white">
      <div className="container mx-auto max-w-6xl">
        ...
        <h2 className="text-3xl md:text-4xl font-black text-center text-gray-900 mb-14 leading-tight">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {steps.map((step) => (
            <div
              key={step.number}
              className="bg-gray-50 rounded-2xl p-8 flex flex-col gap-5 border border-gray-100 hover:shadow-md transition-shadow"
            >
              {/* Step number circle */}
