    ...
    <Card className="w-full max-w-4xl mx-auto border-2 border-border rounded-3xl overflow-hidden shadow-xl">
      <CardHeader className="bg-primary text-primary-foreground p-8">
        ...
        <p className="text-primary-foreground/80">
          Register your laboratory facility with Testraca
        </p>
      </CardHeader>
      <CardContent className="p-8">
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <Label htmlFor="labName" className="font-bold">
                  Laboratory Name *
                </Label>
                <Input
                  id="labName"
              ...
              <div className="space-y-2">
                <Label htmlFor="ownershipType" className="font-bold">
                  Ownership Type *
                </Label>
                <Select
                  onValueChange={(value) =>
          ...
          <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <Label htmlFor="labCategory" className="font-bold">
                  Lab Category *
                </Label>
                <Select
                  onValueChange={(value) =>
                    setFormData({ ...formData, labCategory: value })
                  }
                >
                  <SelectTrigger className="rounded-xl">
              ...
              <div className="space-y-2">
                <Label htmlFor="dailyCapacity" className="font-bold">
                  Daily Test Capacity (Range) *
                </Label>
                <Select
                  onValueChange={(value) =>
                    setFormData({ ...formData, dailyCapacity: value })
                  }
                >
                  <SelectTrigger className="rounded-xl">
          ...
          <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2 space-y-2">
                <Label htmlFor="fullAddress" className="font-bold">
                  Full Lab Address *
                </Label>
                <Textarea
                  id="fullAddress"
          ...
          <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-1 gap-6">
              <div className="space-y-2">
                <Label htmlFor="acceptsExternalSamples" className="font-bold">
                  Accepts External Samples? *
                </Label>
                <Select
                  onValueChange={(value) =>
                    setFormData({ ...formData, acceptsExternalSamples: value })
                  }
                >
                  <SelectTrigger className="rounded-xl">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <Label htmlFor="pickupWindow" className="font-bold">
                    Sample Pickup Time Window
                  </Label>
                  <Input
                    id="pickupWindow"
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, pickupWindow: e.target.value })
                    }
                    className="rounded-xl"
                  />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="tat" className="font-bold">
                    Turnaround Time (TAT) per test category
                  </Label>
                  <Input
                    id="tat"
