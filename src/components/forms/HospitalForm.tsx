    ...
    return (
        <Card className="w-full max-w-4xl mx-auto border-2 border-border rounded-3xl overflow-hidden shadow-xl">
            <CardHeader className="bg-primary text-primary-foreground p-8">
                <CardTitle className="text-3xl font-black">Hospital / Clinic Registration Form</CardTitle>
                <p className="text-primary-foreground/80">Partner your healthcare facility with Labtraca</p>
            </CardHeader>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <Label htmlFor="facilityName" className="font-bold">Hospital/Clinic Name *</Label>
                                <Input
                                    id="facilityName"
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="facilityType" className="font-bold">Facility Type *</Label>
                                <Select onValueChange={(value) => setFormData({ ...formData, facilityType: value })}>
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="ownership" className="font-bold">Ownership *</Label>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div className="md:col-span-2 space-y-2">
                                <Label htmlFor="address" className="font-bold">Facility Address *</Label>
                                <Textarea
                                    id="address"
