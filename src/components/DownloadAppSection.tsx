export const DownloadAppSection = () => {
  return (
    <section id="download" className="py-16 md:py-24 px-4 md:px-8 bg-white">
      <div className="container mx-auto max-w-6xl text-center space-y-6">
        <h2 className="text-3xl md:text-5xl font-black text-gray-900 leading-tight max-w-2xl mx-auto">
          Ready to prioritize your health?
        </h2>
        <p className="text-gray-500 text-base md:text-lg max-w-md mx-auto leading-relaxed">
          Download the Labtraca app and get started in seconds. Fast, reliable diagnostics at your fingertips.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-2">
          ...
          <a
            ...
            className="inline-flex items-center gap-3 bg-gray-900 hover:bg-gray-800 text-white rounded-xl px-6 py-3.5 transition-colors shadow-sm min-w-[180px]"
          >
            <svg viewBox="0 0 28.5 32" className="w-6 h-6 flex-shrink-0" xmlns="http://www.w3.org/2000/svg">
